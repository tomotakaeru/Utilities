...
\lstset{ %ソースコードの見た目設定
  ...
  commentstyle={\scriptsize\color[rgb]{0.6,0.1,0.1}},
  keywordstyle={\footnotesize\bfseries\color[rgb]{0.4,0.8,0.4}},
  ndkeywordstyle={\scriptsize},
  stringstyle={\scriptsize\ttfamily},
  identifierstyle={\footnotesize\ttfamily\bfseries\color[rgb]{0.3,0.3,0.8}}, 
